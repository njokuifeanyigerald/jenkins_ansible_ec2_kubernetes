            ...
            steps{
                ...
                script{
                    sshagent(['ansible_server']) {
                        ...
                        sh 'ssh -o StrictHostKeyChecking=no ubuntu@172.31.38.161 cd /home/ubuntu'
                        sh 'ssh -o StrictHostKeyChecking=no ubuntu@172.31.38.161 sudo ansible -m ping node'
                        sh 'ssh -o StrictHostKeyChecking=no ubuntu@172.31.38.161 sudo ansible-playbook ansible.yml'
                    }
                }
            }
            post{
